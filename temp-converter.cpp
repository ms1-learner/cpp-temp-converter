...
void convertFahrenheitToCelsius() {
    ...
    std::cout << celsius << " degrees Fahrenheit is " << fahrenheit << " degrees Celsius." << std::endl;
}
...
int main() {
    ...
    std::cout << "Enter f if you want to convert from Celsius to Fahrenheits" << std::endl;
